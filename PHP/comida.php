...
<body>
<center>
<h1>Registra tu comida</h1>
<form action = "registrocom.php" method = "POST">
<table cellpadding = "20" width = "1000" align ="center" border ="4">
<tr>
<td><h2>Usuario</h2></td>
<td><h2>Fecha</h2></td>
<td><h2>Tipo de Comida</h2></td>
</tr>
<tr>
<td>
	<h2>
...
$sql = "SELECT tipo, Id_TC FROM t_comida";
$result = mysql_query($sql);

echo "<select name='tcomida'>";
while ($row = mysql_fetch_array($result)) {
    echo "<option value='" . $row['Id_TC'] ."'>" . $row['tipo'] ."</option>";
}
echo "</select>";
...
<a href="principal.php"><button type="submit">Regresar</button></a>
